...
func (c *current) onhelp1() (interface{}, error) {
	return NewHelpCmd()
}

func (p *parser) callonhelp1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onhelp1()
}

func (c *current) onexit1() (interface{}, error) {
	// exit the program
	return NewExitCmd()
}

func (p *parser) callonexit1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
...
func (p *parser) callonraceName1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onraceName1()
}
...
func (p *parser) callonstop1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
